...
function PokemonInfo({pokemonName}) {
  ...
  }, [cache, dispatch, pokemonName, run, setData]) // Add dispatch to silence ES lint error, but the reducer used by useReducer won't change so this isn't doing anything
